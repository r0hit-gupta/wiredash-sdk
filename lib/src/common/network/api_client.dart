...
class ApiClient {
  ...
  static const String _host =
      'https://us-central1-wiredash-75f17.cloudfunctions.net/app/';
  ...
  Future<Map<String, dynamic>> get(String urlPath) async {
    final url = Uri.parse('$_host$urlPath');

    final BaseResponse response = await httpClient
        .get(url, headers: {'project': projectId, 'authorization': secret});
  ...
  Future<Map<String, dynamic>> post({
    ...
    if (files != null && files.isNotEmpty) {
      ...
      response = await httpClient.post(
        url,
        headers: {'project': projectId, 'authorization': secret},
        body: arguments,
      );
